  ...
  return (
    <div className="py-16 bg-white dark:bg-black">
      <div className="container px-4 mx-auto">
        <h2 className="mb-12 text-4xl font-black text-center text-gray-900 dark:text-white">NEW ARRIVALS</h2>
        
        <div className="grid grid-cols-1 gap-6 mb-8 md:grid-cols-2 lg:grid-cols-4">
          {products.map((product) => (
            <div key={product._id} className="overflow-hidden transition-shadow bg-white border border-gray-200 rounded-lg dark:bg-gray-900 dark:border-gray-800 hover:shadow-lg">
